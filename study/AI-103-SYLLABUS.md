...
| D2.2.c | Integrate agent tools: APIs, knowledge stores, search, content understanding, custom functions | Evaluado | **En aprendizaje** | DIAG-1 p9 parcial: catálogo incompleto, confunde modalidad (voz) con tool. E-006. Material 2026-08-08/09: `notes/D2-apps-y-agentes/07` § Tools · `/08-las-cuatro-tools.md` · `/11-tools-personalizadas.md` (las 4 formas de custom tool) — **sin verificar** |
