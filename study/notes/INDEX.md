...
| 11 | [D2/12 Foundry IQ](D2-apps-y-agentes/12-foundry-iq.md) | RAG gestionado y compartido — **sigue al 06** |
| 12 | [D2/09 Multi-agente](D2-apps-y-agentes/09-multi-agente-y-orquestacion.md) | Varios agentes coordinados |
| 13 | [D1/03 Cuotas y rate limits](D1-plataforma/03-cuotas-y-rate-limits.md) | Capacidad y coste — **encaja con D1/01** |
| 14 | [D1/04 Seguridad](D1-plataforma/04-seguridad-identidad-y-red.md) | Identidad, RBAC y red |
| 15 | [D1/02 IA responsable](D1-plataforma/02-ia-responsable.md) | Filtros, riesgos y salida a producción |
| 16 | [D2/10 Observabilidad](D2-apps-y-agentes/10-observabilidad-y-tracing.md) | Ya en producción: qué pasó por dentro |
| 17 | [D1/05 GenAIOps y CI/CD](D1-plataforma/05-genaiops-cicd-y-monitoreo.md) | Cierra el ciclo: evaluar, desplegar, monitorizar |
...
| [12 Foundry IQ](D2-apps-y-agentes/12-foundry-iq.md) | Capa de conocimiento **compartida entre agentes** · las **6 fuentes de datos** · SharePoint Remote vs Indexed · instructions que fuerzan cita · se conecta por **MCP** |
...
| SharePoint Remote | SharePoint Indexed | [D2/12](D2-apps-y-agentes/12-foundry-iq.md) |
| RAG a medida | Foundry IQ (gestionado, compartido) | [D2/12](D2-apps-y-agentes/12-foundry-iq.md) |
...
**17 apuntes ≈ 29 de los 44 objetivos del temario (~66%).**
